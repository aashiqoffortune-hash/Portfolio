...
RESUME = {
    ...
    "engagements": {
        ...
        # What every report carries, whatever the engagement found. This
        # describes the deliverable a client pays for, so it lives with the
        # commercial content rather than with a sample that no longer exists.
        "carries": [
