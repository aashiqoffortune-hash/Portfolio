...
Anything on the site that illustrates the work runs against an invented
environment. This checks it stayed that way — that no lab hostname, vendor
name, real credential, proving-grounds address range or flag format is
anywhere in the built output, including inside the JavaScript and the
stylesheet.
...
# and any other RFC 1918 examples on the site.
